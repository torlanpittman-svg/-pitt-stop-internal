...
export async function GET(req: Request) {
  ...
  try {
    ...
    logger.info('cron:finance-sync', 'synced', { balances, transactions, obligations, inflows })
    return NextResponse.json({ ok: true, balances, transactions, obligations, inflows })
  } catch (err) {
